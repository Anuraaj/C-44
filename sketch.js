...
function setup()
{
  ...
  gold = createSprite(380,20,2,2);
  gold.addImage(bookIMG);
  gold.scale = 0.3;

  laser1 = createSprite(100, 0, 200, 5);
  laser1.shapeColor = "red";
  laser1.velocityY = 0.7;

  laser2 = createSprite(300, 400, 200, 5);
  laser2.shapeColor = "red";
  laser2.velocityY = -0.7;

  laser3 = createSprite(300, 150, 70, 5);
  ...
  laser5.rotation = 45;
  laser5.setSpeedAndDirection(2,45);
  ...
  pass = createSprite(22,185,10,10);
  pass.addImage(keyIMG);
  pass.scale = 0.3;
...
function draw()
{
  ...
  //laser1.rotationSpeed = randomNumber(-10,+10);
  //laser2.rotationSpeed = randomNumber(-10,+10);
  laser3.rotationSpeed = -3;
  laser4.rotationSpeed = 3;


  //shape(390, 0, 380, 10, 390, 20, 400, 10);
  //shape.shapeColor = "white";

  

  if(agent.isTouching(pass))
  {
    keyStatus = "held";
  }
  if(keyStatus === "held")
  ...
  if(agent.isTouching(gold))
  {
    stroke(0);
    fill(0);
    textSize(24);
    //  text("Theif Wins",120,200);
      laser1.setVelocity(0,0);
      laser1.rotationSpeed = 0;
